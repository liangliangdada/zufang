...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        <div class="layui-logo"><h3>企业管理系统</h3></div>
        ...
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                <a href="javascript:void(0);">
                    <img src="${request.getContextPath()}/images/head.png" class="layui-nav-img">
                    <#--${user.name}-->
                </a>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="menu">
                ...
                <li class="layui-nav-item">
                    ...
                    <a data-url="${request.getContextPath()}${item.url}" data-id="${item.id}" data-title="${item.name}" href="javascript:void(0);" class="site-active">${item.name}</a>
                    <#else>
                ...
                <dl class="layui-nav-child">
                    ...
                    <dd><a data-url="${request.getContextPath()}${children.url}" data-id="${children.id}" data-title="${children.name}" href="javascript:void(0);" class="site-active">${children.name}</a></dd>
                </#if>
            </#list>
            </dl>
        </#if>
    ...
    <div class="layui-tab" lay-filter="tab" lay-allowClose="false">
        ...
        <div class="layui-tab-content" style="height: 100%">
            <div class="layui-tab-item layui-show" style="height: calc(100vh - 200px);">
                <iframe data-frameid="0" scrolling="auto" frameborder="0" src="${request.getContextPath()}/home/main" style="width:100%;height:100%;"></iframe>
            </div>
        </div>
    </div>
</div>
...
<div id="password-win" style="display: none">
    <form class="layui-form" lay-filter="password-form-filter" action="${request.getContextPath()}/password" method="post" style="margin-top: 10px">
        <div class="layui-form-item" align="left">
            <label class="layui-form-label">原密码：</label>
            <div class="layui-input-block">
                <input type="text" style="width: 90%"  name="oldPassword" required  lay-verify="required"  placeholder="请输入原密码" autocomplete="off"  class="layui-input">
            </div>
        </div>
        <div class="layui-form-item" align="left">
            <label class="layui-form-label">新密码：</label>
            <div class="layui-input-block">
                <input type="text" style="width: 90%"  name="password" required  lay-verify="required"  placeholder="请输入新密码" autocomplete="off"  class="layui-input">
            </div>
        </div>
